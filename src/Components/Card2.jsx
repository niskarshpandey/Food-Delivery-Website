      ...
      <div className= 'w-[60%] h-full flex gap-5'>
        ...
        <div className='w-[40%] h-full flex flex-col gap-5' > 
          ...
          <div className='w-[110px] h-[50px] bg-slate-400 flex rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-orange-400 text-xl '>
              <button className='w-[30%] h-full bg-white flex justify-center items-center text-orange-400 hover:text-black hover:bg-gray-400'>-</button>
...
<RiDeleteBin6Line className='inline ml-2 text-2xl text-red-600 hover:text-black cursor-pointer'/>
